...
class MovieApi
{
    ...
    public function findByIdFormatted(int $movieId) : ?array
    {
        ...
        return [
            ...
            'posterPath' => $this->urlGenerator->generateImagePosterSrcUrlFromParameters($entity->getTmdbPosterPath(), $entity->getPosterPath()),
            'backdropPath' => $this->urlGenerator->generateImageBackdropSrcUrlFromParameters($entity->getTmdbBackdropPath()),
