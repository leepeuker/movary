...
function addWebRoutes(RouterService $routerService, FastRoute\RouteCollector $routeCollector) : void
{
    ...
    $routes->add('GET', '/settings/account/delete-ratings', [Web\SettingsController::class, 'deleteRatings'], [Web\Middleware\UserIsAuthenticated::class, Web\Middleware\HttpRefererIsAllowed::class]);
    $routes->add('GET', '/settings/account/delete-history', [Web\SettingsController::class, 'deleteHistory'], [Web\Middleware\UserIsAuthenticated::class, Web\Middleware\HttpRefererIsAllowed::class]);
    $routes->add('GET', '/settings/account/delete-account', [Web\SettingsController::class, 'deleteAccount'], [Web\Middleware\UserIsAuthenticated::class, Web\Middleware\HttpRefererIsAllowed::class]);
