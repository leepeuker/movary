...
final class AddJellyfinWebhookId extends AbstractMigration
{
    public function down() : void
    {
        $this->execute(
            ...
            ALTER TABLE user DROP COLUMN jellyfin_scrobble_watches;
            SQL,
        );
    }
    ...
    public function up() : void
    {
        $this->execute(
            ...
            ALTER TABLE user ADD COLUMN jellyfin_scrobble_watches TINYINT DEFAULT 1 NOT NULL AFTER jellyfin_webhook_uuid;
            SQL,
        );
    }
}
