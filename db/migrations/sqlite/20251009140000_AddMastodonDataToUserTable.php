    ...
    public function down() : void
    {
        $this->execute(
            ...
            CREATE TABLE `tmp_user` (
                ...
                `kodi_scrobble_views` INTEGER DEFAULT 1,
                ...
                `display_tmdb_rating` INTEGER DEFAULT 1,
                `display_imdb_rating` INTEGER DEFAULT 1,
    ...
    public function up() : void
    {
        $this->execute(
            ...
            CREATE TABLE `tmp_user` (
                ...
                `display_tmdb_rating` INTEGER DEFAULT 1,
                `display_imdb_rating` INTEGER DEFAULT 1,
                `mastodon_xpost_enabled` INTEGER DEFAULT 0,
                `mastodon_xpost_automatic` INTEGER DEFAULT 1,
                `mastodon_xpost_username` TEXT DEFAULT NULL,
                `mastodon_xpost_access_token` TEXT DEFAULT NULL,
                `mastodon_xpost_post_visibility` TEXT DEFAULT "public",
                `created_at` TEXT NOT NULL,
                PRIMARY KEY (`id`),
                UNIQUE (`email`), 
                UNIQUE (`name`)
