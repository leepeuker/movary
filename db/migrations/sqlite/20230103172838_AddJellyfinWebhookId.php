...
final class AddJellyfinWebhookId extends AbstractMigration
{
    public function down() : void
    {
        ...
        $this->execute('INSERT INTO `tmp_user` (id, email, name, password, privacy_level, date_format_id, trakt_user_name, plex_webhook_uuid, trakt_client_id, plex_scrobble_ratings, core_account_changes_disabled, created_at) SELECT id, email, name, password, privacy_level, date_format_id, trakt_user_name, plex_webhook_uuid, trakt_client_id, plex_scrobble_ratings, core_account_changes_disabled, created_at FROM user');
